...
| [vm-authorization/](vm-authorization/01-vm-authorization.md) | 보안 그룹 (Security Group) CRUD 및 규칙 관리 | `/v1/resource/policies/security-group/*` |
...
| 메서드 | 경로 | 설명 |
|---|---|---|
| GET | `/v1/resource/policies/security-group` | 보안 그룹 목록 |
| POST | `/v1/resource/policies/security-group` | 보안 그룹 등록 |
| GET | `/v1/resource/policies/security-group/{id}` | 보안 그룹 상세 |
| PUT | `/v1/resource/policies/security-group/{id}` | 보안 그룹 수정 |
| DELETE | `/v1/resource/policies/security-group/{id}` | 보안 그룹 삭제 |
| POST | `/v1/resource/policies/security-group/{id}/rule` | 규칙 추가 |
| DELETE | `/v1/resource/policies/security-group/{id}/rule/{ruleId}` | 규칙 삭제 |
