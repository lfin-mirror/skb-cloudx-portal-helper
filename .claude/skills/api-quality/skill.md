...
| 2 | resource-infra | `admin-portal/api/resource/hosts`, `networks`, `templates`, `security-group` | `app-ms-resource: rest/host`, `rest/network`, `rest/template` 등 | `resource/host-*.json`, `network-*.json` 등 |
